...
?>
 ...
 <div id="content" class="no-bottom no-top">
            ...
            <!-- section begin -->
            <section id="section-intro" class="full-height relative owl-slide-wrapper text-light no-top no-bottom" data-bgimage="url(images/background/18.jpg)" data-stellar-background-ratio=".2"> <!--- 5, 6,  -->
                    ...
                    <div class="row align-items-center">
							...
							<div class="row sequence">
								...
								<div class="col-md-6 mb40 sq-item wow sq-item wow">
									<div class="feature-box style-2 left">
										...
										<div class="text">
											<h3>Website Design & Mobile Application Development</h3>
											We provide web design solution for your brand/company
										</div>
									</div>
								</div>
								<!-- feature box close -->
								...
								<div class="col-md-6 feature-box mb40 sq-item wow">
									<div class="feature-box style-2 left">
										...
										<div class="text">
											...
											We provide a digital marketing service, assuring 100% good converstion rate.
										</div>
									</div>
								</div>
								<!-- feature box close -->
								...
								<div class="col-md-6 feature-box sm-mb40 sq-item wow">
									<div class="feature-box style-2 left">
										...
										<div class="text">
                                            ...
                                            We analyze planning how the brand should be perceived if it is to achieve its objectives
										</div>
									</div>
								</div>
								<!-- feature box close -->
								...
								<div class="col-md-6 feature-box sm-mb40 sq-item wow">
									<div class="feature-box style-2 left">
										...
										<div class="text">
											<h3>Data Science</h3>
											We use Artifical Intelligence (ML) to help grow your business, giving more insight for better forecast.
										</div>
									</div>
								</div>
								<!-- feature box close -->
						...
						<div class="col-md-4">
							<figure class="picframe invert transparent hover-shadow rounded">
                                ...
                                <img src="images/misc/2.jpg" class="img-fullwidth" alt="">
                            </figure>
						</div>
					</div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-6 mb-sm-30">
                            <div class="de_count">
                                <h3 class="timer" data-to="2340" data-speed="2500">0</h3>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-6 mb-sm-30">
                            <div class="de_count">
                                <h3 class="timer" data-to="10">0</h3>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-5 offset-md-1">
                            <h2 class="mb20">Pinza Studio do creative works. We ready to help you.</h2>
