...
<div id="content" class="no-bottom no-top">
            ...
            <!-- section begin -->
            <section id="subheader" class="text-light" data-bgimage="url(images/background/5.jpg)" data-stellar-background-ratio=".2">
                <div class="overlay-bg t50">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1>About Us</h1>
								<p>Creative Software Development &amp; Data Science</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row no-gutters">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="profile_pic text-center">
                                <figure class="picframe sc-icon mb20">
                                    ...
                                    <img src="images/team/CEO.jpeg" class="img-fluid" style="max-height: 700px;" alt="">
                                </figure>

                                <h3>Oluwaseun Samuel Ajiboye</h3>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="profile_pic text-center">
                                ...
                                <span class="subtitle">Co-Founder & UI/UX Developer</span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="profile_pic text-center">
                                ...
                                <span class="subtitle">Chief Financial Officer (CFO)</span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="profile_pic text-center">
                                <figure class="picframe sc-icon mb20">
                                    ...
                                    <img src="images/team/fed.jpg" style="max-height: 700px;"  class="img-fluid" alt="">
                                </figure>

                                <h3>Ferdinand Oshomegi</h3>
                                <span class="subtitle">Digital Marketing Manager & Front-end Developer </span>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="profile_pic text-center">
                                ...
                                <span class="subtitle">Public Relation Officer (PRO) & Brand Ambassador</span>
                            </div>
                        </div>
                    </div>
				</div>
